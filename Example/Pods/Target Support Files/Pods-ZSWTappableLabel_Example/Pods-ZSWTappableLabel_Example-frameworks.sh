...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-ZSWTappableLabel_Example/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework 'ZSWTaggedString.framework'
  install_framework 'ZSWTappableLabel.framework'
fi
